...
12. 구매자가 판매자의 상품을 예약하면 판매자 센터 상단에 새 예약 알림이 표시됩니다. **들어온 예약**에서 고객 정보를 확인한 뒤 **계약서 보내기**를 누르면 구매자 페이지 알림과 로그인 이메일로 계약 안내가 전달됩니다. 구매자는 페이지 알림을 눌러 웹사이트 안에서 전자서명을 진행할 수 있습니다.
